...
public class BaseApriori<V> extends AbstractApriori<V> {
	...
	public BaseApriori(List<ItemSet<V>> transactions, Double minSupport,
			Double minConf) {
		super(transactions, minSupport, minConf);
	}
	...
	public void apriori() {
		...
		for (int i = 2;; i++) {
			...
			// prune
			frequentCandidatesLevel = pruneInfrequentCandidates(minSup,
